        ...
        <div id="kt_content_container" class="container-xxl">
            ...
            <div class="card add-question">
                ...
                <div class="card-body pt-0">
                    <form method="POST" action="{{route('admin.StorechangePassword',$adminId)}}" id="changePass" class="form fv-plugins-bootstrap5 fv-plugins-framework">
                        <!--begin::Scroll-->
                        @csrf
                        @method('PUT')
                        ...
                        <div class="text-center pt-10 pt-sm-15">
                            <a href="{{route('admin.dashboard')}}" class="btn btn-danger me-3" data-kt-users-modal-action="cancel">Discard</a>
