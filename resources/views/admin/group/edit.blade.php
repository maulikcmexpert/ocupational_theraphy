                            ...
                            <div class="row internalhtml">
                                ...
                                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
                                    <div class="fv-row mb-7 fv-plugins-icon-container">
                                        ...
                                        <!--end::Label-->
                                        <!--begin::Input-->
                                        <input type="text" name="total_session" class="form-control form-control-solid mb-3 mb-lg-0 update_total_session" id="total_session" placeholder="Number Of Sessions" min="{{ ($session_start != '')?$groupDetail[0]->total_session:0}}" value="{{ $groupDetail[0]->total_session}}">
                                        <!--end::Input-->
