                                ...
                                <div class="form-check">
                                    ...
                                    <div>
                                        <?php if ($val->ques_type == 'check') { ?>
                                            <input class="form-control" type="hidden" name="question_id[]" value="{{ $val->id }}">
                                            <input class="form-control" type="hidden" name="answer[{{ $val->id }}]" value="0">
                                            <input class="form-check-input" name="answer[{{ $val->id }}]" type="checkbox" value="1" id="flexCheckDefault">
                                        <?php } ?>
                                    </div>
                                </div>
                            <?php } ?>
