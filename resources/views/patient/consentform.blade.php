                                    ...
                                    <div class="text-type-input">
                                        <label class="form-check-label " for="flexCheckDefault_{{ $val->id }}">
                                            ...
                                            <span>
                                                ...
                                                <input class="form-control " type="text" name="questions[{{ $key }}][answer]" value="{{(count($consentAnswers) !=0 && $consentAnswers[$key]->answer !=null)?$consentAnswers[$key]->answer.' disabled'.' disabled':''}}">
                                            </span>
                                            @endif
                                        </label>
                                ...
                                @if ($key >= 5 && $key <= 8) <div class="form-check">
                                    <div>
                                        <label class="form-check-label" for="flexCheckDefault_{{ $val->id }}">
                                            ...
                                            @if ($val->ques_type == 'text')
                                            <input type="hidden" name="questions[{{ $key }}][question]" value="{{ $val->id }}">
                                            <input class="form-control" type="text" name="questions[{{ $key }}][answer]" value="{{(count($consentAnswers) !=0 && $consentAnswers[$key]->answer !=null)?$consentAnswers[$key]->answer.' disabled':''}}">
                                            @endif
                                        </label>
                                    </div>
                                    <div>
